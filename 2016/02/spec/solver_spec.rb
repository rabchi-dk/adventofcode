...
THE_ACTUAL_CHALLANGE = "
...
RSpec.describe "solver" do
  ...
  context "actual challange" do
    it "solves an actual challenge" do
      solver = Solver.new
      expect(solver.solve("5", THE_ACTUAL_CHALLANGE)).to eq("84452")
    end
  end
end
...
RSpec.describe "secondsolver" do
  ...
  context "actual challange" do
    it "solves an actual challenge" do
      solver = SecondSolver.new
      expect(solver.solve("5", THE_ACTUAL_CHALLANGE)).to eq("D65C3")
    end
  end
